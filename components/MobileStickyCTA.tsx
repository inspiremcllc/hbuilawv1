...
export function MobileStickyCTA() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-3 border-t border-white/20 bg-[var(--gold-action)] pb-[env(safe-area-inset-bottom)] text-white md:hidden">
      <a
        href={phoneHref}
